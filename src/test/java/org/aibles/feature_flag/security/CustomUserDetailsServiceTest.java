...
/**
 * Unit tests for {@link CustomUserDetailsService}: resolves the Admin-chain principal by email,
 * mapping a {@link User} to {@link UserPrincipal} or failing fast when absent.
 */
...
class CustomUserDetailsServiceTest {
  ...
  void loadsUserPrincipalByEmail() {
    ...
    User user = User.builder().id(id).email("user@example.com").passwordHash("hashed").build();
