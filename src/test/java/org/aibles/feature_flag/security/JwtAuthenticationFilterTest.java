...
/**
 * Unit tests for {@link JwtAuthenticationFilter} (Admin chain). Verifies the SecurityContext is
 * populated only for a well-formed, valid Bearer token and that the chain always proceeds.
 */
...
class JwtAuthenticationFilterTest {
  ...
  void doesNotAuthenticateWhenUserNoLongerExists() throws Exception {
    ...
    when(tokenProvider.getEmailFromToken("valid-token-deleted-user"))
