...
class FeatureFlagRepositoryTest {
    ...
    void setUp() {
        ...
        Organization org = persist(Organization.builder()
    ...
    void findAllByProjectIdAndArchivedFalse_excludesArchivedFlags() {
        ...
        assertThat(result).extracting(FeatureFlag::getKey)
    ...
    void findByProjectIdAndKey_returnsEmpty_whenKeyDoesNotExist() {
        ...
        Optional<FeatureFlag> result = flagRepository.findByProjectIdAndKey(project.getId(), "no-such-key");
