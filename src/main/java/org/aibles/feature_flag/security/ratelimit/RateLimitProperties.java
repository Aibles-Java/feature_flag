...
/**
 * Configuration for the API rate limiter (issue #26), bound from {@code app.rate-limit.*}.
 * All values are runtime-configurable via properties — no code change needed to tune limits.
 *
