...
public final class RolloutEvaluator {
  ...
  /**
   * Deterministic percentage rollout using MurmurHash3. Same identifier + flagKey always produces
   * the same bucket (0-99), so the same user always gets the same result for a given rollout %.
   */
